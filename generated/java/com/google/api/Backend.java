...
private static final long serialVersionUID = 0L;
  ...
  private Backend(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  private Backend() {
   ...
   * </pre>
   *
   * <code>repeated .google.api.BackendRule rules = 1 [json_name = "rules"];</code>
   */
  @java.lang.Override
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.api.Backend result) {
      if (rulesBuilder_ == null) {
    ...
    private void buildPartial0(com.google.api.Backend result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.api.BackendRule m =
                  input.readMessage(
                      com.google.api.BackendRule.parser(),
                      extensionRegistry);
              if (rulesBuilder_ == null) {
                ensureRulesIsMutable();
                rules_.add(m);
