...
private static final long serialVersionUID = 0L;
   ...
   * </pre>
   *
   * <code>repeated string requirements = 1 [json_name = "requirements"];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.api.UsageRule rules = 6 [json_name = "rules"];</code>
   */
  @java.lang.Override
   ...
   * </pre>
   *
   * <code>string producer_notification_channel = 7 [json_name = "producerNotificationChannel"];</code>
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(producerNotificationChannel_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, producerNotificationChannel_);
    }
          ...
          switch (tag) {
            ...
            case 50: {
              com.google.api.UsageRule m =
                  input.readMessage(
                      com.google.api.UsageRule.parser(),
                      extensionRegistry);
              if (rulesBuilder_ == null) {
                ensureRulesIsMutable();
                rules_.add(m);
