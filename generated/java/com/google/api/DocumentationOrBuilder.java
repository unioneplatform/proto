...
public interface DocumentationOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.api.Page pages = 5 [json_name = "pages"];</code>
   */
   ...
   * </pre>
   *
   * <code>repeated .google.api.DocumentationRule rules = 3 [json_name = "rules"];</code>
   */
   ...
   * </pre>
   *
   * <code>string documentation_root_url = 4 [json_name = "documentationRootUrl"];</code>
   ...
   * </pre>
   *
   * <code>string overview = 2 [json_name = "overview"];</code>
   * @return The overview.
   */
